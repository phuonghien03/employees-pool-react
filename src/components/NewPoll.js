...
const NewPoll = ({ authUser, questions, users, updateQuestions, updateUsers, history }) => {
      ...
      <GridContainer>
        <Segment.Group>
          <Header as="h3" block attached="top" textAlign="center">
            <Header.Content>Create New Pool</Header.Content>
          </Header>
          <Grid padded>
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(NewPoll));
